...
Widget defaultButton(
  ...
  @required String text,
      ...
      decoration: BoxDecoration(
        ...
        color: background, // width: double.infinity,
      ),
        ...
        Expanded(
          child: Container(
            ...
            child: Column(
              ...
              children:
              [
                Expanded(child: Text('${article['title']}',maxLines: 2,overflow:TextOverflow.ellipsis ,style:Theme.of(context).textTheme.bodyText1,)),
...
Widget myDivider() => Container(width: double.infinity,height: 1,color: Colors.grey,);
