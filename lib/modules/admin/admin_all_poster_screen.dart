...
class AdminAllPosterScreen extends StatefulWidget {
  @override
  State<AdminAllPosterScreen> createState() =>
      _AdminAllPosterScreenState();
}

class _AdminAllPosterScreenState
    extends State<AdminAllPosterScreen> {
