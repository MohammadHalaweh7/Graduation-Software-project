...
class ShopkeeperAllOrdersScreen extends StatefulWidget {
  @override
  State<ShopkeeperAllOrdersScreen> createState() =>
      _ShopkeeperAllOrdersScreenState();
}

class _ShopkeeperAllOrdersScreenState extends State<ShopkeeperAllOrdersScreen> {
  fetchData fetch = fetchData();
  Widget getAllOrders() {
    return FutureBuilder(
        future: fetch.getAllStoreorders(),
