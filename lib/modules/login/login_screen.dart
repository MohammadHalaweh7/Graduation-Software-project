                  ...
                  SizedBox(
                    ...
                    Container(
                      ...
                      FloatingActionButton.extended(
                        ...
                        label:Text("قم بتسجبل الدخول باستخدام الفيسبوك",style: TextStyle(color: Colors.white),), // <-- Text
                        icon: Icon( // <-- Icon
                          Icons.facebook,
                          size: 24.0,
                        ),
                    ...
                    Container(
                      ...
                      FloatingActionButton.extended(
                        ...
                        label:Text("قم بتسجبل الدخول باستخدام جوجل",style: TextStyle(color: Colors.white),), // <-- Text
                        icon: Icon( // <-- Icon
                    ...
                    Container(
                      ...
                      FloatingActionButton.extended(
                        ...
                        label:Text("قم بتسجيل الدخول باستخدام الهاتف",style: TextStyle(color: Colors.white),), // <-- Text
                        icon: Icon( // <-- Icon
                          Icons.phone,
                          size: 24.0,
                        ),
